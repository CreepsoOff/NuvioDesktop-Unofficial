    ...
    BoxWithConstraints(
        ...
        if (maxWidth >= 768.dp) {
            TabletSettingsScreen(
                ...
                homescreenAlwaysAnimateCollectionGifs = homescreenSettingsUiState.alwaysAnimateCollectionGifs,
...
private fun MobileSettingsScreen(
    ...
    homescreenAlwaysAnimateCollectionGifs: Boolean,
        ...
        NuvioScreen {
            ...
            when (page) {
                ...
                SettingsPage.Homescreen -> homescreenSettingsContent(
                    ...
                    alwaysAnimateCollectionGifs = homescreenAlwaysAnimateCollectionGifs,
