...
data class PlayerControlsState(
    ...
    val videoSettingsResetLabel: String = "Reset",
    val videoSettingsResetDescription: String = "",
    val desktopVideoDebandLabel: String = "Deband",
    val desktopVideoDebandDescription: String = "",
    val desktopVideoInterpolationLabel: String = "Interpolation",
    val desktopVideoInterpolationDescription: String = "",
    val desktopVideoBrightnessLabel: String = "Brightness",
    val desktopVideoContrastLabel: String = "Contrast",
    val desktopVideoSaturationLabel: String = "Saturation",
    val desktopVideoGammaLabel: String = "Gamma",
