...
internal actual val DefaultPosterCardWidthDp: Int = 180
internal actual val DefaultPosterCardHeightDp: Int = 270
internal actual val PosterCardWidthOptions: List<PosterCardWidthOption> = listOf(
    PosterCardWidthOption("Compact", 140),
    PosterCardWidthOption("Standard", 160),
    PosterCardWidthOption("Comfort", 180),
    PosterCardWidthOption("Large", 220),
    PosterCardWidthOption("Cinema", 240),
    PosterCardWidthOption("Showcase", 260),
)
